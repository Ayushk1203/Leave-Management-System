...
class uservisiblepage:
    def __init__(self,root):
        ...
        btn_applyleave=Button(frame_lside, text="+ Apply Leave", fg="white", bg="blue", font=("arial",15,"bold"))
        ...
        #==============================logo user====================================================================
        self.logo2=ImageTk.PhotoImage(file=r"D:\Vocational Training project\images\resized\logou.png")
        bg1_logo2=Label(frame_top,image=self.logo2, bg="white",bd=10)
        bg1_logo2.place(x=1390,y=20,height=90,width=90)

        lbl_userl=Label(frame_top, text="Employee", bg="lightgrey", fg="black", font=("ALGERIAN",15,"italic"))
        lbl_userl.place(x=1380, y=120)
